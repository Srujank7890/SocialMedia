 ...
 *
 * @description If the email domain of the user's email is "mod.socialmedia.com", the user will be
...
const addUser = async (req, res, next) => {
  ...
  const role = emailDomain === "mod.socialmedia.com" ? "moderator" : "general";
